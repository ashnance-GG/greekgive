      ...
      <div style={{ maxWidth: "900px", margin: "0 auto" }}>
        ...
        <div style={{ background: "#F4ECE3", borderRadius: "18px", padding: "24px", marginBottom: "30px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <label style={{ position: "relative", display: "inline-block", width: "54px", height: "28px" }}>
            ...
            <span style={{ position: "absolute", cursor: "pointer", inset: 0, backgroundColor: paymentsEnabled ? "#8B8F6A" : "#ccc", borderRadius: "28px", transition: ".3s" }}>
              <span style={{ position: "absolute", height: "22px", width: "22px", left: paymentsEnabled ? "28px" : "4px", bottom: "3px", backgroundColor: "white", borderRadius: "50%", transition: ".3s" }} />
            </span>
          </label>
        </div>
